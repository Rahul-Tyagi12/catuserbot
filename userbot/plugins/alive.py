...
CUSTOM_ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "✮ MY MARKBOTBOT IS RUNNING SUCCESSFULLY ✮"
...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} Markuserbot Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} Markuserbot Version :** `{catversion}`\n"
